...
rmdir /s /q "%appdata%\Forge\custom\cards\hlw" >nul 2>&1
rmdir /s /q "%appdata%\Forge\custom\cards\mhlw" >nul 2>&1
rmdir /s /q "%appdata%\Forge\custom\tokens\hlw" >nul 2>&1
rmdir /s /q "%appdata%\Forge\custom\tokens\mhlw" >nul 2>&1
goto :eof
